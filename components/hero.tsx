...
//           {/* Mobile: Card first, Content second */}
//           <div className="flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            
//             {/* TiltedCard - First on mobile, second on desktop */}
//             <motion.div
//               initial={{ opacity: 0, y: 20 }}
//               animate={{ opacity: 1, y: 0 }}
//               transition={{ duration: 0.7, delay: 0.2 }}
...
//                 altText="Пример продающего сайта"
//                 captionText="Интернет-магазин CosmoStore - +200% к продажам"
//                 containerHeight="clamp(320px, 70vw, 500px)"
//                 containerWidth="100%"
//                 imageHeight="clamp(320px, 70vw, 500px)"
//                 imageWidth="clamp(320px, 70vw, 500px)"
//                 rotateAmplitude={25}
//                 scaleOnHover={1.15}
...
// export function Hero() {
//   return (
//     <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 px-4 bg-background">
//       {/* Animated Background */}
//       <div className="absolute inset-0 overflow-hidden">
//         <motion.div
//           animate={{
...
//             ease: "easeInOut",
//           }}
//           className="absolute bottom-1/4 right-1/4 w-64 h-64 md:w-96 md:h-96 bg-primary/10 rounded-full blur-3xl"
//         />
//       </div>
...
//                 enableGyroscope={true}
//                 overlayContent={
//                   <div className="absolute top-2 left-2 right-2 bg-black/70 backdrop-blur-sm rounded-lg p-3 md:p-4 border border-border">
//                     <p className="text-white font-semibold text-base md:text-xl text-center mb-1 md:mb-2">Интернет-магазин SuleonAuto</p>
//                     <p className="text-white/80 text-sm md:text-base text-center">+200% к продажам после запуска</p>
//                   </div>
//                 }
...
//                 className="text-lg md:text-xl text-muted-foreground mb-6 md:mb-8 max-w-lg leading-relaxed"
//               >
//                 Разрабатываем сайты, которые приносят реальные продажи. 
//                 Аудит, стратегия, разработка и поддержка под ключ.
//               </motion.p>
...
//               >
//                 <Link href="#contact">
//                   <Button size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground text-base md:text-lg px-6 md:px-8 h-11 md:h-12 w-full sm:w-auto rounded-lg">
//                     Получить бесплатный аудит
//                     <ArrowRight className="ml-2" size={18} />
//                   </Button>
//                 </Link>
...
//                     variant="outline" 
//                     size="lg" 
//                     className="border-border text-foreground hover:border-primary hover:text-primary text-base md:text-lg px-6 md:px-8 h-11 md:h-12 w-full sm:w-auto rounded-lg"
//                   >
//                     Посмотреть кейсы
//                     <ArrowRight className="ml-2" size={18} />
//                   </Button>
